...
class QuadraticEquationSolver {
    ...
    public Pair<Complex, Complex> solve(double a, double b, double c) {
        ...
        Complex solution1 = new Complex(-b, 0).plus(sqrtDiscriminant)
                .divides(new Complex(2, 0)).divides(new Complex(a, 0));
        Complex solution2 = new Complex(-b, 0).minus(sqrtDiscriminant)
                .divides(new Complex(2, 0)).divides(new Complex(a, 0));
        return new Pair<>(solution1, solution2);
    }
}
